...
- `npm run test`: 104 files, 635 tests passed on the rebased PR branch, including retrospective Add Time, midnight rollover, selectable-day clamping, and quick-log overlap coverage.
